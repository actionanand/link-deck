...
https://actionanand.github.io/link-deck/
...
```bash
git clone https://github.com/actionanand/link-deck.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/link-deck#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/link-deck -b 1-skeleton
```
